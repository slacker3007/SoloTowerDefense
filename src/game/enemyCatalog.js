...
const catalogEntries = [
  ...
  entry({
    ...
    designSpeed: 0.55,
    designGold: 10,
    description: "Heavy unit with uniform damage resistance—tough but fair vs all tower types.",
    tags: ["tank"],
    abilities: [{ type: "damageResistance", multiplier: 0.75 }],
  }),
  entry({
    key: "linked",
  ...
  entry({
    ...
    designSpeed: 0.9,
    designGold: 8,
    description: "Magical barrier absorbs chip damage; reduced mitigation to HP.",
    tags: ["shielded"],
    abilities: [{ type: "damageShield", reduction: 0.7 }],
  ...
  entry({
    ...
    designSpeed: 0.8,
    designGold: 8,
    description: "Regenerates health unless burst down—slower regen at high HP.",
    tags: ["regenerator"],
    abilities: [{ type: "regen", hpPercentPerSecond: 0.015 }],
  }),
  entry({
    key: "splitter",
    name: "Splitter",
